...
{
 public static object Capabilities()=>new{version=AppIdentity.Version,feature="Self-Healing Appliance",localFirst=true,mandatoryRuntimeCostSek=0,productionVerified=false};
