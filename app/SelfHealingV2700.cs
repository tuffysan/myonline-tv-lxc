...
{
 public static object Capabilities()=>new{version="30.0.2",feature="Self-Healing Appliance",localFirst=true,mandatoryRuntimeCostSek=0,productionVerified=false};
