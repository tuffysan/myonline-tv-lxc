...
{
 public static object Capabilities()=>new{version="31.1.3",feature="Self-Healing Appliance",localFirst=true,mandatoryRuntimeCostSek=0,productionVerified=false};
