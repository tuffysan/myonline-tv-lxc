...
{
 public static object Capabilities()=>new{version="30.0.0",feature="Self-Healing Appliance",localFirst=true,mandatoryRuntimeCostSek=0,productionVerified=false};
