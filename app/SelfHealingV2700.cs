...
{
 public static object Capabilities()=>new{version="28.1.0",feature="Self-Healing Appliance",localFirst=true,mandatoryRuntimeCostSek=0,productionVerified=false};
