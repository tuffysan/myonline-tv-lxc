...
{
 public static object Capabilities()=>new{version="31.2.0",feature="Self-Healing Appliance",localFirst=true,mandatoryRuntimeCostSek=0,productionVerified=false};
