...
{
 public static object Capabilities()=>new{version="30.0.1",feature="Self-Healing Appliance",localFirst=true,mandatoryRuntimeCostSek=0,productionVerified=false};
