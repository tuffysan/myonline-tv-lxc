...
{
 public static object Capabilities()=>new{version=AppIdentity.Version,feature="Unified Watchlist",localFirst=true,mandatoryRuntimeCostSek=0,productionVerified=false};
