...
if ($version -ne "34.0.3") { throw "VERSION is not 34.0.3" }
if (-not $csprojText.Contains("<Version>34.0.3</Version>")) { throw "csproj version mismatch" }
if ($release.version -ne "34.0.3") { throw "release.json version mismatch" }
...
Write-Host "Static v34.0.3 cleanup checks passed." -ForegroundColor Green
...
Write-Host "v34.0.3 verified: build passed with zero compiler warnings." -ForegroundColor Green
