# v31.2.0 compile hotfix

This corrected v31.2.0 fixes the build failure in `LocalDb.cs`.
...
- Kept version 31.2.0 because the original build failed and was not published.
