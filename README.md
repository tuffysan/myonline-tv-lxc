# MyOnline TV Web v0.5.7 — Proxmox LXC
...
## Live TV browser playback (v0.5.7)
...
## Stable baseline: v0.5.7

v0.5.7 deliberately uses the last user-confirmed working application baseline (v0.4.6) for Live TV, Guide, Movies and Series, while retaining the corrected GitHub release/update infrastructure.
...
## v0.5.7 updater correction

v0.5.7 fixes a false "required asset is missing" error in `scripts/github-common.sh`.
