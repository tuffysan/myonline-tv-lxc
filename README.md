# MyOnline TV Web v0.4.14 — Proxmox LXC
...
## Live TV browser playback (v0.4.14)
...
## Stable baseline: v0.4.14

v0.4.14 deliberately uses the last user-confirmed working application baseline (v0.4.6) for Live TV, Guide, Movies and Series, while retaining the corrected GitHub release/update infrastructure.
