# MyOnline TV Web v22.0.0 — Proxmox LXC
...
The application also binds only to `1222.0.0.1:5080`; Nginx remains the public entry point on port 80.
...
## v22.0.0 — First stable milestone
v22.0.0 is the cumulative first major milestone of MyOnline TV Web.
