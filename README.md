# MyOnline TV Web v23.0.0 — Proxmox LXC
...
The application also binds only to `1223.0.0.1:5080`; Nginx remains the public entry point on port 80.
...
## v23.0.0 — First stable milestone
v23.0.0 is the cumulative first major milestone of MyOnline TV Web.
