# MyOnline TV Web v0.6.1 — Proxmox LXC
...
## Live TV browser playback (v0.6.1)
...
## Stable baseline: v0.6.1

v0.6.1 deliberately uses the last user-confirmed working application baseline (v0.4.6) for Live TV, Guide, Movies and Series, while retaining the corrected GitHub release/update infrastructure.
...
## v0.6.1 updater correction

v0.6.1 fixes a false "required asset is missing" error in `scripts/github-common.sh`.
