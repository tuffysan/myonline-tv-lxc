# MyOnline TV Web v0.3.5 — Proxmox LXC
...
v0.3.5 detects the Proxmox host architecture before creating the container:
...
## v0.3.5 installation verification
...
Before activating a new version, v0.3.5 creates:
...
```text
myonline-tv-web-v0.3.5-linux-x64.tar.gz
myonline-tv-lxc-v0.3.5-source.tar.gz
