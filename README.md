# MyOnline TV Web v25.0.0 — Proxmox LXC
...
The application also binds only to `1225.0.0.1:5080`; Nginx remains the public entry point on port 80.
...
## v25.0.0 — First stable milestone
v25.0.0 is the cumulative first major milestone of MyOnline TV Web.
