# MyOnline TV Web v8.0.1 — Proxmox LXC
...
The application also binds only to `128.0.1.1:5080`; Nginx remains the public entry point on port 80.
...
## v8.0.1 — First stable milestone
v8.0.1 is the cumulative first major milestone of MyOnline TV Web.
