# MyOnline TV Web v20.6.2 — Proxmox LXC
...
The application also binds only to `1220.6.2.1:5080`; Nginx remains the public entry point on port 80.
...
## v20.6.2 — First stable milestone
v20.6.2 is the cumulative first major milestone of MyOnline TV Web.
