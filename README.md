# MyOnline TV Web v0.5.4 — Proxmox LXC
...
## Live TV browser playback (v0.5.4)
...
## Stable baseline: v0.5.4

v0.5.4 deliberately uses the last user-confirmed working application baseline (v0.4.6) for Live TV, Guide, Movies and Series, while retaining the corrected GitHub release/update infrastructure.
...
## v0.5.4 updater correction

v0.5.4 fixes a false "required asset is missing" error in `scripts/github-common.sh`.
