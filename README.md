# MyOnline TV Web v34.0.0 — Proxmox LXC

> **Current release: v34.0.0 — Advanced Features**
> See `RELEASE-v34.0.0.md` for scope and verification.


> **Current release: v33.0.0 — TV Experience**
> See `RELEASE-v33.0.0.md` for scope and verification.


> **Current release: v32.0.0 — Playback & Stability**
> See `RELEASE-v32.0.0.md` for scope and verification.
...
The application also binds only to `1226.0.0.1:5080`; Nginx remains the public entry point on port 80.
...
## v31.2.0 — First stable milestone
v31.2.0 is the cumulative first major milestone of MyOnline TV Web.
