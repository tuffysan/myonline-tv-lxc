...
- Fixed diagnostics code referencing non-existent `MediaLibraryConfig`.
- Diagnostics now uses existing `LoadMediaLibraries()` / `MediaLibraryProvider` model.
