...
## v0.5.4 — Stability & Cache Foundation
...
## v0.5.4 — Movies + Series artwork regression fix
...
- Includes `PUBLISH-v0.5.4.ps1` and `.cmd` to add, commit, push `main`, recreate/push tag `v0.5.4`, and trigger the GitHub release workflow.
- Live TV, Guide and media playback code paths are otherwise unchanged.

## v0.5.4 — Movies catalogue timeout fix
...
## v0.5.4 — Stable 0.5.4
- Incremental release in the v0.4.16 → v0.5.4 test train.
- Preserves all fixes and features from the previous release.
- Focus: Stable 0.5.4.

## v0.5.4 — Release candidate / feature freeze
- Incremental release in the v0.4.16 → v0.5.4 test train.
- Preserves all fixes and features from the previous release.
- Focus: Release candidate / feature freeze.

## v0.5.4 — Release hardening
- Incremental release in the v0.4.16 → v0.5.4 test train.
- Preserves all fixes and features from the previous release.
- Focus: Release hardening.

## v0.5.4 — Regression checks
- Incremental release in the v0.4.16 → v0.5.4 test train.
- Preserves all fixes and features from the previous release.
- Focus: Regression checks.

## v0.5.4 — Upgrade safety
- Incremental release in the v0.4.16 → v0.5.4 test train.
- Preserves all fixes and features from the previous release.
- Focus: Upgrade safety.

## v0.5.4 — Error recovery
- Incremental release in the v0.4.16 → v0.5.4 test train.
- Preserves all fixes and features from the previous release.
- Focus: Error recovery.

## v0.5.4 — Accessibility/keyboard polish
- Incremental release in the v0.4.16 → v0.5.4 test train.
- Preserves all fixes and features from the previous release.
- Focus: Accessibility/keyboard polish.

## v0.5.4 — Mobile/tablet polish
- Incremental release in the v0.4.16 → v0.5.4 test train.
- Preserves all fixes and features from the previous release.
- Focus: Mobile/tablet polish.

## v0.5.4 — Backup/restore polish
- Incremental release in the v0.4.16 → v0.5.4 test train.
- Preserves all fixes and features from the previous release.
- Focus: Backup/restore polish.

## v0.5.4 — System page polish
- Incremental release in the v0.4.16 → v0.5.4 test train.
- Preserves all fixes and features from the previous release.
- Focus: System page polish.

## v0.5.4 — Downloads polish
- Incremental release in the v0.4.16 → v0.5.4 test train.
- Preserves all fixes and features from the previous release.
- Focus: Downloads polish.

## v0.5.4 — Player UX polish
- Incremental release in the v0.4.16 → v0.5.4 test train.
- Preserves all fixes and features from the previous release.
- Focus: Player UX polish.

## v0.5.4 — Player reliability polish
- Incremental release in the v0.4.16 → v0.5.4 test train.
- Preserves all fixes and features from the previous release.
- Focus: Player reliability polish.

## v0.5.4 — Search debounce/performance
- Incremental release in the v0.4.16 → v0.5.4 test train.
- Preserves all fixes and features from the previous release.
- Focus: Search debounce/performance.

## v0.5.4 — Artwork/browser cache hints
- Incremental release in the v0.4.16 → v0.5.4 test train.
- Preserves all fixes and features from the previous release.
- Focus: Artwork/browser cache hints.

## v0.5.4 — Provider management polish
- Incremental release in the v0.4.16 → v0.5.4 test train.
- Preserves all fixes and features from the previous release.
- Focus: Provider management polish.

## v0.5.4 — Profile-scoped history
- Incremental release in the v0.4.16 → v0.5.4 test train.
- Preserves all fixes and features from the previous release.
- Focus: Profile-scoped history.

## v0.5.4 — Profile-scoped favourites
- Incremental release in the v0.4.16 → v0.5.4 test train.
- Preserves all fixes and features from the previous release.
...
## v0.5.4 — TV/remote focus navigation
- Incremental release in the v0.4.16 → v0.5.4 test train.
- Preserves all fixes and features from the previous release.
...
## v0.5.4 — Home favourites/history rails
- Incremental release in the v0.4.16 → v0.5.4 test train.
- Preserves all fixes and features from the previous release.
- Focus: Home favourites/history rails.

## v0.5.4 — Continue Watching polish
- Incremental release in the v0.4.16 → v0.5.4 test train.
- Preserves all fixes and features from the previous release.
- Focus: Continue Watching polish.

## v0.5.4 — Local watch history
- Incremental release in the v0.4.16 → v0.5.4 test train.
- Preserves all fixes and features from the previous release.
- Focus: Local watch history.

## v0.5.4 — Series favourites
- Incremental release in the v0.4.16 → v0.5.4 test train.
- Preserves all fixes and features from the previous release.
...
## v0.5.4 — Live favourites quick filter
- Incremental release in the v0.4.16 → v0.5.4 test train.
- Preserves all fixes and features from the previous release.
- Focus: Live favourites quick filter.

## v0.5.4 — Player/session cleanup hardening
- Incremental release in the v0.4.16 → v0.5.4 test train.
- Preserves all fixes and features from the previous release.
- Focus: Player/session cleanup hardening.

## v0.5.4 — Movies/Series catalogue cache
- Incremental release in the v0.4.16 → v0.5.4 test train.
- Preserves all fixes and features from the previous release.
- Focus: Movies/Series catalogue cache.

## v0.5.4 — GET retry/timeout handling
- Incremental release in the v0.4.16 → v0.5.4 test train.
- Preserves all fixes and features from the previous release.
- Focus: GET retry/timeout handling.

## v0.5.4 — Diagnostics polish
- Incremental release in the v0.4.16 → v0.5.4 test train.
- Preserves all fixes and features from the previous release.
- Focus: Diagnostics polish.

## v0.5.4 — Release smoke test
- Incremental release in the v0.5.4 → v0.5.4 test train.
- Preserves all fixes and features from the previous release.
- Focus: Release smoke test.

## v0.5.4 — updater download fix
...
## v0.5.4 — Stable release workflow fix
...
- Release workflow accepts preferred `v0.5.4` tags and legacy-compatible `v.0.5.4` tags.
- Updater normalizes both tag formats to the canonical artifact name `myonline-tv-web-v0.5.4-linux-x64.tar.gz`.
...
- Version and release metadata updated to 0.5.4.
