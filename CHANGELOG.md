...
## v0.6.1 — Stable Feature Release
- Promotes the v0.5.x feature train to the v0.6.1 stable feature baseline.
...
## v0.6.1 — Profiles, Permissions & Parental Controls
...
## v0.6.1 — Admin & Provider Management
...
## v0.6.1 — Stability & Cache Foundation
...
## v0.6.1 — Movies + Series artwork regression fix
...
- Includes `PUBLISH-v0.6.1.ps1` and `.cmd` to add, commit, push `main`, recreate/push tag `v0.6.1`, and trigger the GitHub release workflow.
- Live TV, Guide and media playback code paths are otherwise unchanged.

## v0.6.1 — Movies catalogue timeout fix
...
## v0.6.1 — Stable 0.6.1
- Incremental release in the v0.4.16 → v0.6.1 test train.
- Preserves all fixes and features from the previous release.
- Focus: Stable 0.6.1.

## v0.6.1 — Release candidate / feature freeze
- Incremental release in the v0.4.16 → v0.6.1 test train.
- Preserves all fixes and features from the previous release.
...
## v0.6.1 — Upgrade safety
- Incremental release in the v0.4.16 → v0.6.1 test train.
- Preserves all fixes and features from the previous release.
- Focus: Upgrade safety.

## v0.6.1 — Error recovery
- Incremental release in the v0.4.16 → v0.6.1 test train.
- Preserves all fixes and features from the previous release.
- Focus: Error recovery.

## v0.6.1 — Accessibility/keyboard polish
- Incremental release in the v0.4.16 → v0.6.1 test train.
- Preserves all fixes and features from the previous release.
- Focus: Accessibility/keyboard polish.

## v0.6.1 — Mobile/tablet polish
- Incremental release in the v0.4.16 → v0.6.1 test train.
- Preserves all fixes and features from the previous release.
- Focus: Mobile/tablet polish.

## v0.6.1 — Backup/restore polish
- Incremental release in the v0.4.16 → v0.6.1 test train.
- Preserves all fixes and features from the previous release.
- Focus: Backup/restore polish.

## v0.6.1 — System page polish
- Incremental release in the v0.4.16 → v0.6.1 test train.
- Preserves all fixes and features from the previous release.
- Focus: System page polish.

## v0.6.1 — Downloads polish
- Incremental release in the v0.4.16 → v0.6.1 test train.
- Preserves all fixes and features from the previous release.
- Focus: Downloads polish.

## v0.6.1 — Player UX polish
- Incremental release in the v0.4.16 → v0.6.1 test train.
- Preserves all fixes and features from the previous release.
- Focus: Player UX polish.

## v0.6.1 — Player reliability polish
- Incremental release in the v0.4.16 → v0.6.1 test train.
- Preserves all fixes and features from the previous release.
- Focus: Player reliability polish.

## v0.6.1 — Search debounce/performance
- Incremental release in the v0.4.16 → v0.6.1 test train.
- Preserves all fixes and features from the previous release.
- Focus: Search debounce/performance.

## v0.6.1 — Artwork/browser cache hints
- Incremental release in the v0.4.16 → v0.6.1 test train.
- Preserves all fixes and features from the previous release.
- Focus: Artwork/browser cache hints.

## v0.6.1 — Provider management polish
- Incremental release in the v0.4.16 → v0.6.1 test train.
- Preserves all fixes and features from the previous release.
- Focus: Provider management polish.

## v0.6.1 — Profile-scoped history
- Incremental release in the v0.4.16 → v0.6.1 test train.
- Preserves all fixes and features from the previous release.
- Focus: Profile-scoped history.

## v0.6.1 — Profile-scoped favourites
- Incremental release in the v0.4.16 → v0.6.1 test train.
- Preserves all fixes and features from the previous release.
...
## v0.6.1 — TV layout polish
- Incremental release in the v0.4.16 → v0.6.1 test train.
- Preserves all fixes and features from the previous release.
- Focus: TV layout polish.

## v0.6.1 — Remote playback controls
- Incremental release in the v0.4.16 → v0.6.1 test train.
- Preserves all fixes and features from the previous release.
- Focus: Remote playback controls.

## v0.6.1 — TV/remote focus navigation
- Incremental release in the v0.4.16 → v0.6.1 test train.
- Preserves all fixes and features from the previous release.
...
## v0.6.1 — Home favourites/history rails
- Incremental release in the v0.4.16 → v0.6.1 test train.
- Preserves all fixes and features from the previous release.
- Focus: Home favourites/history rails.

## v0.6.1 — Continue Watching polish
- Incremental release in the v0.4.16 → v0.6.1 test train.
- Preserves all fixes and features from the previous release.
- Focus: Continue Watching polish.

## v0.6.1 — Local watch history
- Incremental release in the v0.4.16 → v0.6.1 test train.
- Preserves all fixes and features from the previous release.
- Focus: Local watch history.

## v0.6.1 — Series favourites
- Incremental release in the v0.4.16 → v0.6.1 test train.
- Preserves all fixes and features from the previous release.
...
## v0.6.1 — Live favourites quick filter
- Incremental release in the v0.4.16 → v0.6.1 test train.
- Preserves all fixes and features from the previous release.
- Focus: Live favourites quick filter.

## v0.6.1 — Player/session cleanup hardening
- Incremental release in the v0.4.16 → v0.6.1 test train.
- Preserves all fixes and features from the previous release.
- Focus: Player/session cleanup hardening.

## v0.6.1 — Movies/Series catalogue cache
- Incremental release in the v0.4.16 → v0.6.1 test train.
- Preserves all fixes and features from the previous release.
- Focus: Movies/Series catalogue cache.

## v0.6.1 — GET retry/timeout handling
- Incremental release in the v0.4.16 → v0.6.1 test train.
- Preserves all fixes and features from the previous release.
- Focus: GET retry/timeout handling.

## v0.6.1 — Diagnostics polish
- Incremental release in the v0.4.16 → v0.6.1 test train.
- Preserves all fixes and features from the previous release.
- Focus: Diagnostics polish.

## v0.6.1 — Release smoke test
- Incremental release in the v0.6.1 → v0.6.1 test train.
- Preserves all fixes and features from the previous release.
- Focus: Release smoke test.

## v0.6.1 — updater download fix
...
## v0.6.1 — Stable release workflow fix
...
- Release workflow accepts preferred `v0.6.1` tags and legacy-compatible `v.0.6.1` tags.
- Updater normalizes both tag formats to the canonical artifact name `myonline-tv-web-v0.6.1-linux-x64.tar.gz`.
...
- Version and release metadata updated to 0.6.1.
